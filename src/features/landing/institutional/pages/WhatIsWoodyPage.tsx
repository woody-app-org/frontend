import { whatIsWoody } from "../content";
...
import { INSTITUTIONAL_HERO_WHAT_IS_WOODY } from "../institutionalMedia";

export function WhatIsWoodyPage() {
  return (
    <main className="relative text-white">
      <section className="relative isolate min-h-svh w-full overflow-hidden">
        ...
        <div className="relative z-10 flex min-h-svh flex-col justify-end px-[var(--layout-gutter)] pb-16 pt-28 md:justify-center md:pb-24 md:pt-32 lg:max-w-none">
          <div className="relative mx-auto w-full max-w-[var(--layout-max-width)]">
            ...
            <div className="max-w-[min(100%,34rem)] md:max-w-[min(100%,38rem)]">
              <h1 className="font-sans text-[clamp(2.35rem,7.5vw,4.75rem)] font-bold leading-[0.98] tracking-[-0.04em] text-white drop-shadow-[0_4px_48px_rgba(0,0,0,0.55)]">
                {whatIsWoody.title}
              </h1>
