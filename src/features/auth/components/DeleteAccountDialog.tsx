      ...
      >
        <DialogHeader className="flex-col items-stretch justify-start gap-2 px-4 pt-5 pb-2 sm:px-6 sm:pt-6">
          <div className="flex items-center gap-3">
            ...
            <DialogTitle className="text-[var(--woody-text)]">Excluir sua conta permanentemente?</DialogTitle>
          </div>
          <DialogDescription className="text-pretty pt-1">
            <span className="font-semibold text-red-600 dark:text-red-400">
              Esta ação é irreversível.
            </span>{" "}
            Sua conta, perfil, publicações, comentários, mensagens, conversas, seguidores, stories e
            todas as suas interações na Woody serão apagados permanentemente e não poderão ser
            recuperados.
          </DialogDescription>
        </DialogHeader>

        <div className="space-y-2 px-4 pb-4 sm:px-6">
          <Label htmlFor="delete-account-confirm" className="text-sm text-[var(--woody-text)]">
            Para confirmar, digite seu nome de usuária{" "}
