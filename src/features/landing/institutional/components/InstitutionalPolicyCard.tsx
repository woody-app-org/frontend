...
export function InstitutionalPolicyCard({ badge, title, excerpt, to, className }: InstitutionalPolicyCardProps) {
  return (
    <Link
      to={to}
      className={cn(
        "group flex h-full flex-col rounded-[1.75rem] bg-white px-7 py-9 transition-[transform,box-shadow] duration-300 ease-out md:rounded-[2rem] md:px-8 md:py-10",
        "hover:-translate-y-0.5 hover:shadow-[0_20px_50px_-28px_rgba(10,10,10,0.18)] active:translate-y-0 motion-safe:active:scale-[0.99]",
