...
export function SearchModeSegment({ value, onChange, className }: SearchModeSegmentProps) {
  ...
  return (
    ...
    >
      <span
        aria-hidden
        className="pointer-events-none absolute inset-y-1 left-1 rounded-full bg-[var(--woody-card)] shadow-[0_1px_2px_rgba(10,10,10,0.06)] border border-[var(--woody-divider)]/80 transition-transform duration-200 ease-out"
        style={{
          width: PILL_WIDTH,
